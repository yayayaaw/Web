...
export function SignatureMenuTab() {
  ...
  function resetOverride(id: string) {
    if (!confirm('Kembalikan kartu ini ke data asli (hapus semua perubahan)?')) return;
      ...
      <div className="flex items-center justify-between bg-white p-4 rounded-2xl border border-[#F4EFE6] shadow-sm">
        <div>
          ...
          <p className="text-xs text-gray-500">
            3 menu tetap yang tampil di homepage (bukan list bebas). Kosongkan field = pakai data asli menu utama.
            Kalau salah isi, tap "Reset ke Data Asli" buat balikin kartu itu.
          </p>
        </div>
