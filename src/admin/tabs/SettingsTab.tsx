...
import { getContent, setContent, ContactSettings } from '../../lib/contentStore';
...
export function SettingsTab() {
  const [settings, setSettings] = useState<ContactSettings>(() => getContent().contact);
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    setContent('contact', settings);
    alert('Pengaturan kontak, sosmed, maps & SEO berhasil disimpan!');
  }
