...
//
// PATCH v3 (final): editor "Filosofi Seduhan Presisi" (brewMethods) DICABUT
// TOTAL dari form ini -- section itu dihapus dari web utama karena isinya
// duplikat dengan "Ketelitian dalam Tiap Seduhan" yang sudah ada di Home.
// Sekarang form Our Story cuma sampai bagian Highlight.
  ...
  return (
    <section className="space-y-6">
      ...
      <form onSubmit={saveAbout} className="bg-white p-6 sm:p-8 rounded-2xl border border-[#F4EFE6] shadow-sm space-y-6">
        ...
        {/* GRUP 3: Highlight (paragraf di bawah cerita) */}
        <div className="pt-4 border-t border-[#F4EFE6] space-y-3">
          <h4 className="font-bold text-sm text-[#1A1A1A]">Highlight Singkat (paragraf di bawah cerita)</h4>
          <p className="text-[11px] text-gray-500 -mt-1">Tampil sebagai paragraf berurutan di web (bukan kartu). Isi judul singkat + kalimat penjelas.</p>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
