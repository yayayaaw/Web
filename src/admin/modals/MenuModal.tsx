...
export function MenuModal({ editingItem, existingCategories, onClose, onSave }: MenuModalProps) {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    onSave({ name, category: category.trim(), price: Number(price) || 0, image: img, description, badge: badge || undefined });
  }
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-xs">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <PriceInput className={inputClass} value={price} onChange={setPrice} placeholder="mis: 48.000" />
            </div>
          </div>
          <div>
