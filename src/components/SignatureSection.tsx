...
export const SignatureSection: React.FC<SignatureSectionProps> = ({
  ...
  const overrides = useContent('signatureOverrides');

  // Gabungkan data asli SIGNATURE_ITEMS dengan override dari CMS (kalau ada).
  // Field yang dikosongkan di CMS otomatis fallback ke data asli.
  const displayedItems: MenuItem[] = SIGNATURE_ITEMS.map((item) => {
