...
// PATCH: foto sekarang dibaca dari CMS (useContent('socialPosts')), bukan
// INSTAGRAM_POSTS statis dari mockData.ts lagi. Bisa dikelola di CMS tab
// Galeri, section "Foto Momen Pengunjung".
export const SocialShowcase: React.FC = () => {
  const posts = useContent('socialPosts');
