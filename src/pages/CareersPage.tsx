...
import { CAFE_INFO, JOB_POSITIONS, CAREER_PERKS } from '../data/mockData';
  ...
  return (
    <div className="space-y-0">
      ...
      <PageHeader
        ...
        title="Tumbuh & Berkarya Bersama Keluarga Élysée"
        description="Kami selalu membuka pintu bagi talenta berdedikasi yang memiliki gairah pada seni kopi spesialti, kehangatan kuliner bistro, dan standar pelayanan prima di Senopati."
