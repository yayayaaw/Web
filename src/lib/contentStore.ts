...
//
// PATCH v5 (fix "Élysée Moments ga ada di CMS"):
// Ditambah `socialPosts` -- foto-foto kecil di section "#ElyseeMoments /
// Cerita Hangat dari Pengunjung Kami" (SocialShowcase.tsx). Sebelumnya ini
// namanya INSTAGRAM_POSTS, hardcode 100% di mockData.ts, gak ada jalur CMS
// sama sekali -- beda dari `galleryPhotos` (foto ruangan/suasana café) yang
// memang sudah lama bisa dikelola dari tab "Galeri Foto Café".
...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  // PATCH v5: default sama persis dengan INSTAGRAM_POSTS lama di mockData.ts
  socialPosts: [
