...
//
// PATCH v7 (fix "halaman Karir CMS ga lengkap dibanding web utama"):
// Ditambah `careersHeader` (eyebrow/title/description banner halaman Karir)
// dan `careerPerks` (6 kartu "Budaya & Keuntungan Staf"). Sebelumnya dua
// ini hardcode 100% di CareersPage.tsx & mockData.ts, gak ada jalur CMS
// sama sekali -- beda dari `jobPositions` yang sudah bisa diedit sejak
// PATCH v6.
...
// PATCH v7: banner/header paling atas di halaman #karir (PageHeader).
// Polanya sama persis kayak pageEyebrow/pageTitle/pageDescription di AboutContent.
...
// PATCH v7: ikon dibatasi ke 6 pilihan ini karena CareersPage.tsx cuma
// punya switch-case buat 6 ikon lucide-react tersebut (Coffee, GraduationCap,
// Award, Utensils, ShieldCheck, Heart). Kalau nanti mau nambah ikon baru,
// switch-case di CareersPage.tsx juga harus ditambah.
...
export interface SiteContent {
  ...
  careersHeader: CareersHeaderContent; // PATCH v7
  careerPerks: CareerPerkItem[]; // PATCH v7
  event: EventContent;
  about: AboutContent;
...
export function getContent(): SiteContent {
  try {
    ...
    return {
      ...
      careersHeader: { ...DEFAULT_CONTENT.careersHeader, ...parsed.careersHeader }, // PATCH v7
      careerPerks: parsed.careerPerks ?? DEFAULT_CONTENT.careerPerks, // PATCH v7
